...
from UDP_Data_Connct_Cent_Serv import *
...
#    print("data stored in local server: ",data_split)
    ...
    print("Data stored in Local Server: ","[",split_twinkler_id,",",split_flashpoint_id,",",split_pos_vale,",",split_now_time,",",split_data_vale,",",split_data_remarks,"]")
