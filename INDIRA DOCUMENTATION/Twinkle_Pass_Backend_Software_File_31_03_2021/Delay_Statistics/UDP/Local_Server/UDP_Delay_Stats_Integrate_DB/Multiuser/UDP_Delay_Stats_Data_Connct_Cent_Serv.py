...
#            print("time_before_connct:",time_before_connct,"\ttime_after_auth_recv:",time_after_auth_recv,"\ttime_taken_comm:",time_taken_comm)
    ...
    arr_delay_stats = np.load("/home/pi/Desktop/Delay_Statistics/UDP/UDP_Delay_Stats_Integrate_DB/Multiuser/Delay_Stats/chkpoint_stats.npy")
    ...
    if arr_delay_stats_len == 5:
        ...
        arr_delay_stats = np.array([])
        np.save("/home/pi/Desktop/Delay_Statistics/UDP/UDP_Delay_Stats_Integrate_DB/Multiuser/Delay_Stats/chkpoint_stats",arr_delay_stats)
    return auth_stat
...
def enter_delay_stats(data,time_taken_comm):
    ...
    count_delay_stats = 0
    count_delay_stats = np.load("/home/pi/Desktop/Delay_Statistics/UDP/UDP_Delay_Stats_Integrate_DB/Multiuser/Delay_Stats/checkpoint_delay.npy")
    local_count_delay_stats = int(count_delay_stats)
    
    conn_delay_stats = sqlite3.connect('/home/pi/Desktop/Delay_Statistics/UDP/UDP_Delay_Stats_Integrate_DB/Multiuser/Delay_Stats/Twinkle_Delay_Stats_Database.db')
    ...
    print("split_count_delay_stats:",split_count_delay_stats)
    ...
    np.save("/home/pi/Desktop/Delay_Statistics/UDP/UDP_Delay_Stats_Integrate_DB/Multiuser/Delay_Stats/checkpoint_delay", count_delay_stats)

    arr_delay_stat = np.load("/home/pi/Desktop/Delay_Statistics/UDP/UDP_Delay_Stats_Integrate_DB/Multiuser/Delay_Stats/chkpoint_stats.npy")
    arr_delay_stat = np.append(arr_delay_stat,time_taken_comm)
    np.save("/home/pi/Desktop/Delay_Statistics/UDP/UDP_Delay_Stats_Integrate_DB/Multiuser/Delay_Stats/chkpoint_stats", arr_delay_stat)
