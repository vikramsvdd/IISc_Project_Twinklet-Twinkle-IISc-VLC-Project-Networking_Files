...
def send_local_data(msg):
    data = msg
    auth_status = client_program(data)
    return auth_status
...
#                data = client_socket.recv(1024).decode()  # receive response
    ...
    arr_delay_stats = np.load("/home/pi/Desktop/Delay_Statistics/TCP/TCP_Delay_Stats_Integrate_DB/Multiuser/Delay_Stats/chkpoint_stats.npy")
    ...
    if arr_delay_stats_len == 5:
        ...
        arr_delay_stats = np.array([])
        np.save("/home/pi/Desktop/Delay_Statistics/TCP/TCP_Delay_Stats_Integrate_DB/Multiuser/Delay_Stats/chkpoint_stats",arr_delay_stats)
...
def enter_delay_stats(data,time_taken_comm):
    ...
    count_delay_stats = 0
    count_delay_stats = np.load("/home/pi/Desktop/Delay_Statistics/TCP/TCP_Delay_Stats_Integrate_DB/Multiuser/Delay_Stats/checkpoint_delay.npy")
    local_count_delay_stats = int(count_delay_stats)
    
    conn_delay_stats = sqlite3.connect('/home/pi/Desktop/Delay_Statistics/TCP/TCP_Delay_Stats_Integrate_DB/Multiuser/Delay_Stats/Twinkle_Delay_Stats_Database.db')
    ...
    np.save("/home/pi/Desktop/Delay_Statistics/TCP/TCP_Delay_Stats_Integrate_DB/Multiuser/Delay_Stats/checkpoint_delay", count_delay_stats)

    arr_delay_stat = np.load("/home/pi/Desktop/Delay_Statistics/TCP/TCP_Delay_Stats_Integrate_DB/Multiuser/Delay_Stats/chkpoint_stats.npy")
    arr_delay_stat = np.append(arr_delay_stat,time_taken_comm)
    np.save("/home/pi/Desktop/Delay_Statistics/TCP/TCP_Delay_Stats_Integrate_DB/Multiuser/Delay_Stats/chkpoint_stats", arr_delay_stat)
