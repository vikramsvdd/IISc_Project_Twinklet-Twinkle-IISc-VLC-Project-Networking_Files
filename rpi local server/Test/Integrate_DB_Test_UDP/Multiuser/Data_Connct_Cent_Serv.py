...
#    arr_delay_stats = np.load("/home/pi/Desktop/Test/Integrate_DB_Test_UDP/Multiuser/Delay_Stats/chkpoint_stats.npy")
...
#        arr_delay_stats = np.array([])
#        np.save("/home/pi/Desktop/Test/Integrate_DB_Test_UDP/Multiuser/Delay_Stats/chkpoint_stats",arr_delay_stats)
    return auth_stat
...
#    
#    count_delay_stats = 0
#    count_delay_stats = np.load("/home/pi/Desktop/Test/Integrate_DB_Test_UDP/Multiuser/Delay_Stats/checkpoint_delay.npy")
#    local_count_delay_stats = int(count_delay_stats)
#    
#    conn_delay_stats = sqlite3.connect('/home/pi/Desktop/Test/Integrate_DB_Test_UDP/Multiuser/Delay_Stats/Twinkle_Delay_Stats_Database.db')
...
#    np.save("/home/pi/Desktop/Test/Integrate_DB_Test_UDP/Multiuser/Delay_Stats/checkpoint_delay", count_delay_stats)
#
#    arr_delay_stat = np.load("/home/pi/Desktop/Test/Integrate_DB_Test_UDP/Multiuser/Delay_Stats/chkpoint_stats.npy")
#    arr_delay_stat = np.append(arr_delay_stat,time_taken_comm)
#    np.save("/home/pi/Desktop/Test/Integrate_DB_Test_UDP/Multiuser/Delay_Stats/chkpoint_stats", arr_delay_stat)
#
